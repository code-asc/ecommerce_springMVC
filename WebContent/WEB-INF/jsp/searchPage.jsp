...
<div id="filterTarget">
<c:forEach items="${requestScope.searchResult}" var="retriveProduct">
                                    <div class="col-sm-3 col-md-3 col-xm-3 col-lg-3" style="float : left">
                                        ...
                                        <a href="user_action_single.html?productID=${retriveProduct.productID}">
                                            <div class="itemthumb">
                                            <img src="${retriveProduct.thumbNailPhoto}" class="img-responsive">
                                            </div>
                                        </a>
                                        <br/>
      ...
      <c:when test="${retriveProduct.discount > 0}">
        ...
        <strong>Rs.${retriveProduct.unitPrice-(retriveProduct.unitPrice*(retriveProduct.discount/100))}</strong>
